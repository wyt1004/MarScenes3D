...
class Viewer:
    ...
    def add_2D_text(self,boxes,ids,colors,box_info,add_to_2D_scene):
        if add_to_2D_scene:
    ...
    def show_3D(self):
        ...
        if self.first_show:
            # self.vi.show(self.actors+self.actors_without_del, axes=1, resetcam=False,  camera={'pos': (0, 0, 0), 'focalPoint': (100, 100, 0), 'viewup': (0, 0, 1)})#
            self.vi.show(self.actors+self.actors_without_del, resetcam=False,  camera={'pos': (-10, 0, 5), 'focalPoint': (5, 0, 2), 'viewup': (0, 0, 1)})#
            # self.vi.show(self.actors+self.actors_without_del, resetcam=False, camera={'pos': (0, 1000, 0), 'focalPoint': (0, 10, 2), 'viewup': (0, 0, 1)}) 
    ...
    def show_2D(self,box_color = (255,0,0),show_box_info=False,show_ids=True,points_colors=(0,0,255), show_box_heading=True, save_dir=None, frame_id=None):
        """
