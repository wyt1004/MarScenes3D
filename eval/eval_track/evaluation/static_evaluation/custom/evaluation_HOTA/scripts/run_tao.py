...
if __name__ == '__main__':
    ...
    default_dataset_config = trackeval_maritime3d.datasets.TAO.get_default_dataset_config()
    ...
    dataset_list = [trackeval_maritime3d.datasets.TAO(dataset_config)]
    metrics_list = []
    for metric in [trackeval_maritime3d.metrics.TrackMAP, trackeval_maritime3d.metrics.CLEAR, trackeval_maritime3d.metrics.Identity,
                   trackeval_maritime3d.metrics.HOTA]:
