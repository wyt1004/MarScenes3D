...
if __name__ == '__main__':
    ...
    default_dataset_config = trackeval_maritime3d.datasets.BDD100K.get_default_dataset_config()
    ...
    dataset_list = [trackeval_maritime3d.datasets.BDD100K(dataset_config)]
    metrics_list = []
    for metric in [trackeval_maritime3d.metrics.HOTA, trackeval_maritime3d.metrics.CLEAR, trackeval_maritime3d.metrics.Identity]:
