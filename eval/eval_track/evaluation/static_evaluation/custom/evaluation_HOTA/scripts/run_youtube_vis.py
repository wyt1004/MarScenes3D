...
if __name__ == '__main__':
    ...
    default_eval_config = trackeval_maritime3d.Evaluator.get_default_eval_config()
    # print only combined since TrackMAP is undefined for per sequence breakdowns
    default_eval_config['PRINT_ONLY_COMBINED'] = True
    default_dataset_config = trackeval_maritime3d.datasets.YouTubeVIS.get_default_dataset_config()
    ...
    dataset_list = [trackeval_maritime3d.datasets.YouTubeVIS(dataset_config)]
    metrics_list = []
    for metric in [trackeval_maritime3d.metrics.TrackMAP, trackeval_maritime3d.metrics.HOTA, trackeval_maritime3d.metrics.CLEAR,
                   trackeval_maritime3d.metrics.Identity]:
        if metric.get_name() in metrics_config['METRICS']:
            # specify TrackMAP config for YouTubeVIS
            if metric == trackeval_maritime3d.metrics.TrackMAP:
