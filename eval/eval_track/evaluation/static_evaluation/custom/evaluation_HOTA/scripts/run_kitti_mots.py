...
if __name__ == '__main__':
    ...
    default_dataset_config = trackeval_maritime3d.datasets.KittiMOTS.get_default_dataset_config()
    ...
    metrics_list = []
    for metric in [trackeval_maritime3d.metrics.HOTA, trackeval_maritime3d.metrics.CLEAR, trackeval_maritime3d.metrics.Identity, trackeval_maritime3d.metrics.JAndF]:
