...
def clean_data(gt_anno, dt_anno, current_class):
    ...
    for i in range(num_gt):
        ...
        if valid_class == 1 and not ignore:
            ...
            ignored_gt.append(-1)
        if gt_anno["name"][i] == "ranch" or gt_anno["name"][i] == "garbage" or gt_anno["name"][i] == "reef" or gt_anno["name"][i] == "ball_rank":
...
def get_official_eval_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    ...
    min_overlaps = np.stack([overlap_0_7, overlap_0_5], axis=0)  # [2, 3, 5] [num_overlap, metric, class]
